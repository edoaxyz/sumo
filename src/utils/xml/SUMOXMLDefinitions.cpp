...
SequentialStringBijection::Entry SUMOXMLDefinitions::tags[] = {
    ...
    { "carFollowing-RailETCS",                  SUMO_TAG_CF_RAIL_ETCS },
...
SequentialStringBijection::Entry SUMOXMLDefinitions::attrs[] = {
    ...
    { "brakingTable",                   SUMO_ATTR_BRAKING_TABLE },
    { "emgBrakingTable",                SUMO_ATTR_EMG_BRAKING_TABLE },
    { "numSamples",                     SUMO_ATTR_NUM_SAMPLES },
...
StringBijection<SumoXMLTag>::Entry SUMOXMLDefinitions::carFollowModelValues[] = {
    ...
    { "RailETCS",    SUMO_TAG_CF_RAIL_ETCS },
    { "CC",          SUMO_TAG_CF_CC },
    { "ACC",         SUMO_TAG_CF_ACC },
